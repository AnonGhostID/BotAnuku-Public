...
let handler = async(m, { conn, text, usedPrefix, command }) => {
	...
	try {
		...
		let fimg = await fetch(`https://api.lolhuman.xyz/api/ephoto3/${command}?apikey=${apiKey}&text1=${encodeURIComponent(l)}&text2=${encodeURIComponent(r)}&text3=${encodeURIComponent(s)}`)
